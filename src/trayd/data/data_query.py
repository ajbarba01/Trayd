...
class DataQuery:
    def __init__(self, granularity: Granularity):
        ...
        self.data_dir = "data"
        self.cache_path: str = get_path(self.data_dir, "cache", f"{self.granularity}_cache_metadata.json")
        self.downloader: ParquetDownloader = DOWNLOADERS[granularity](self.cache_path, self.data_dir)
