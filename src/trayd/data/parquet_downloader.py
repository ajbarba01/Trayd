...
class ParquetDownloader:
    def __init__(self, cache_path: str, data_dir: str, granularity: Granularity, data_path: str = None):
    ...
    def query_all(self, symbols: list[str], start_date: str, end_date: str) -> bool:
    ...
    def merge_with_old(self, symbol: str, new_df: pd.DataFrame):
        ...
        if os.path.exists(path):
            ...
            sym_df_combined = sym_df_combined[~sym_df_combined.index.duplicated(keep="last")]
    ...
    def _needs_download(self, symbol: str, start_date: str, end_date: str) -> bool:
