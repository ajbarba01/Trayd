...
class ProgressBar:
    def __init__(self, description: str = "Processing", leave: bool = False, show_unit: bool = True):
        self.item_idxs = {}
        self.items = []
        self.total = 0
    ...
    def _get_description(self):
        return f"{self.description}: {self.current_unit}" if self.show_unit else f"{self.description}"
