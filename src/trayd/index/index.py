...
class Index:
    ...
    def load_all_npz(self, start_date_str: str) -> pd.Timestamp:
        ...
        # ------------------
        # Set start date and update
        # ------------------
        self.index_start_date = min(self.all_timestamps)
        self.current_symbols.clear()  # reset current symbols
        self.update_to(start_date)
